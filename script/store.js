(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Ceramic-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.$emptyCartBtn = this.$shoppingCartActions.find( "#clear-cart" ); // Empty cart button
			...
			this.paypalCurrency = "AUD"; // PayPal's currency code
